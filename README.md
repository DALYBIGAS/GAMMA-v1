...
Apply required patch and build:
...
These are automatically generated via scripts:
...
This runs full system simulation in gem5. 
...
Ensure environment variables (LLVM, SODA-OPT) are set

Network required for model download (HuggingFace)

Debug flags available in gem5 for tracing